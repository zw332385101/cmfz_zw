...
<script>
$(function(){
    $("#albumAdd").form('load','${pageContext.request.contextPath}/album/findByAlbum?id=${param.id}');
})
    
</script>
<div style="text-align: center">
    <form id="albumAdd" method="post" class="easyui-form">
        ...
        <div style="margin-top:20px;">
            ...
            <div style="margin-top:20px;">
            图片：<input type="text" name="coverImg" class="easyui-textbox">
        </div>
        <div style="margin-top:20px;">
